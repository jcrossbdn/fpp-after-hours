...
if (isset($_GET['runStartScript'])) {
  ...
  header("Location: ?plugin=fpp-after-hours&page=fpp-after-hours-oldui.php");
  exit;
}
...
if (isset($_GET['loadInternetMedia'])) { //internet radio tab
  echo "<font size=-1><form method='post' enctype='multipart/form-data' action='?plugin=fpp-after-hours&page=fpp-after-hours-oldui.php&activeTab=1'>";
...
/*if (isset($_GET['fah-adv-updatePlugin'])) {
  ...
  echo "<strong>Command Complete.</strong> &nbsp; &nbsp; <a href='?plugin=fpp-after-hours&page=fpp-after-hours-oldui.php&activeTab=2'>Click here to go back</a>";
  exit;
}
...
if (isset($_GET['loadAdvanced'])) {  //local media tab
  ...
  echo "<br><br><hr><strong>Plugin Github Status</strong> &nbsp; <a href='?plugin=fpp-after-hours&page=fpp-after-hours-oldui.php&fah-adv-updatePlugin&nopage'>Click here to update</a><br>";
  echo "<a href='?plugin=fpp-after-hours&page=fpp-after-hours-oldui.php&fah-adv-updatePlugin&gitHard&nopage'>reset --hard</a> if you have made local changes to the plugin<br><br>";
...
if (isset($_GET['installDependencies'])) {
  ...
  echo "<br><div align=\"center\"><a href='?plugin=fpp-after-hours&page=fpp-after-hours-oldui.php'>Click here to return to after hours plugin page</a></div>";
...
if (!$fah->dependenciesAreLoaded) {
  ...
  <div id=\"elements\" class=\"settings\">
    <fieldset>
      ...
      <div align=\"center\"><a href='?plugin=fpp-after-hours&page=fpp-after-hours-oldui.php&installDependencies'>Install now (this may take several minutes)</a><br>will run <i>sudo apt-get -y update && sudo apt-get -y install mpd mpc</i><br><strong>PLEASE REBOOT ONCE INSTALL HAS COMPLETED!</strong></div>
    </fieldset>
  </div>
  <br><br>
  ";
  ...
  if ($fah->config !== false) { //only show now play and control if the plugin has been configured (config file must exist)
      ...
      <script>
        function getElements() {
          $.ajax({
            type: \"GET\",
            dataType: \"json\",
            url: \"?plugin=fpp-after-hours&page=fpp-after-hours-oldui.php&nowPlaying&nopage\",
            dataType: \"html\",
    ...
    echo "
      <div><a href='?plugin=fpp-after-hours&page=fpp-after-hoursNew.php'>Switch to new UI</a></div><br>
      <div id=\"elements\" class=\"settings\">
        <fieldset>
      ...
      <div id=\"elements\" class=\"settings\">
        <fieldset>
          ...
          <div align=\"center\">
            <table border=0><tr><td><a href='?plugin=fpp-after-hours&page=fpp-after-hours-oldui.php&runStartScript&nopage'>Run Start Script</a></td><td> &nbsp; &nbsp; &nbsp; &nbsp; </td><td><a href='?plugin=fpp-after-hours&page=fpp-after-hours-oldui.php&runStopScript&nopage'>Run Stop Script</a></td><td> &nbsp; &nbsp; &nbsp; &nbsp; </td><td><a id='fpp-after-hours-vup' href='?plugin=fpp-after-hours&page=fpp-after-hours-oldui.php&vup&nopage'>Volume +</a></td><td> &nbsp; &nbsp; &nbsp; &nbsp; </td><td><a id='fpp-after-hours-vup' href='?plugin=fpp-after-hours&page=fpp-after-hours-oldui.php&vdn&nopage'>Volume -</a></td></tr></table>
    ";
  ...
  echo "
    ...
    <div id=\"elements\" class=\"settings\">
      <fieldset>
        ...
        <div id=\"tabs\">
          <ul>
            <!--<li><a href=\"?plugin=fpp-after-hours&page=fpp-after-hours-oldui.php&loadLocalMedia&nopage\">Local Media</a></li>-->
            <li><a href=\"?plugin=fpp-after-hours&page=fpp-after-hours-oldui.php&loadInternetMedia&nopage\">Internet Radio</a></li>
            <li><a href=\"?plugin=fpp-after-hours&page=fpp-after-hours-oldui.php&loadAdvanced&nopage\">Advanced</a></li>
          </ul>
        </div>
      </fieldset>
    </div>
